...
#SBATCH --array=0-4%1
#SBATCH --gres=gpu:1
#SBATCH --output=train_logs/slurm_logs/%A_pointattn_self_attn/%a.out
#SBATCH -J pointattn_self_attn
...
# ============================================================
LOG_DIR_FILE=~/3d_diffuser_actor/train_logs/slurm_logs/${SLURM_ARRAY_JOB_ID}_pointattn_self_attn/log_dir.txt
