...
#SBATCH -J trajectory_flow_matching
# ============================================================
...
run_log_dir=3d_diffuser_actor__flow_matching_$task_desc-C$embedding_dim-B$batch_size-lr$lr-H$num_history-DT$diffusion_timesteps-RN$rot_noise-PN$pos_noise-PCDN$pcd_noise-FPS$fps_subsampling_factor
