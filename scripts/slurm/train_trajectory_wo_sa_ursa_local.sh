...
#SBATCH --array=0-4%1
#SBATCH --gres=gpu:1
#SBATCH --output=train_logs/slurm_logs/%A_3d_diffuser_actor_wo_sa_ursa_local/%a.out
#SBATCH -J 3d_diffuser_actor_wo_sa_ursa_local
# ============================================================
...
run_log_dir=3d_diffuser_actor_wo_sa_ursa_local_$task_desc-C$embedding_dim-B$batch_size-lr$lr-H$num_history-DT$diffusion_timesteps-RN$rot_noise-PN$pos_noise-PCDN$pcd_noise-FPS$fps_subsampling_factor
...
# ============================================================
LOG_DIR_FILE=~/3d_diffuser_actor/train_logs/slurm_logs/${SLURM_ARRAY_JOB_ID}_3d_diffuser_actor_wo_sa_ursa_local/log_dir.txt
