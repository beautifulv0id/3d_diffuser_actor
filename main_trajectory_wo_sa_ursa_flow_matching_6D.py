...
from diffuser_actor.trajectory_optimization.diffuser_actor_wo_sa_ursa_flow_matching_6D import DiffuserActorWoSAURSA
...
class Arguments(tap.Tap):
    ...
    exp_log_dir: str = "exp"
    run_log_dir: str = "run"
    name: str = '3d_diffuser_actor_wo_sa_ursa_flow_matching_6D'
