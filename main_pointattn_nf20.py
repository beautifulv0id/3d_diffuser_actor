...
from action_flow.se3_flow_matching_felix_enc_x1_100_diff_geo3_8layers_12_heads_no_do import SE3FlowMatching
...
class Arguments(tap.Tap):
    ...
    exp_log_dir: str = "exp"
    run_log_dir: str = "run"
    name: str = 'train_point_attention_felix_enc_x1_100_diff_geo3_8_layers_12_heads_no_do'
