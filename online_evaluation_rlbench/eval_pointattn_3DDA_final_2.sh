...
seed=0
checkpoint_raw_folder=/media/funk/INTENSO/300_RL_BENCH/0_evals/final_trains_29_01_evening/place_shape_in_shape_sorter/3dda/09.37.24_Actor_18Peract_100Demo_multitask/diffusion_multitask-C120-B4-lr1e-4-DI1-2-H3-DT100
...
for ((i=0; i<$num_ckpts; i++)); do
    ...
    --output_file $checkpoint_raw_folder/${tasks[$i]}_eval$1_$j.json  \
