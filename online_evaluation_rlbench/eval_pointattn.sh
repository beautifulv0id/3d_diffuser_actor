...
seed=0
checkpoint=train_logs/2025.01.22/19.38.26_Actor_18Peract_100Demo_multitask/diffusion_multitask-C32-B1-lr1e-4-DI1-2-H3-DT100/best.pth
hyper_params_file=train_logs/2025.01.22/19.38.26_Actor_18Peract_100Demo_multitask/diffusion_multitask-C32-B1-lr1e-4-DI1-2-H3-DT100/hparams.json
action_dim=8
