...
num_eval_iters=5
data_dir=/media/funk/INTENSO/300_RL_BENCH/peract_from_cluster/test/
...
seed=0
checkpoint_raw_folder=/media/funk/INTENSO/300_RL_BENCH/0_evals/2025.01.22/PointAttn_18Peract_100Demo_open_drawer/diffusion_multitask-C120-B2-lr1e-4-DI1-2-H3-DT100/diffusion_multitask-C120-B2-lr1e-4-DI1-2-H3-DT100
checkpoint_raw_folder=/media/funk/INTENSO/300_RL_BENCH/0_evals/2025.01.22/PointAttn_18Peract_100Demo_open_drawer/diffusion_multitask-C120-B2-lr1e-4-DI1-2-H3-DT100/diffusion_multitask-C120-B2-lr1e-4-DI1-2-H3-DT100
checkpoint_raw_folder=/media/funk/INTENSO/300_RL_BENCH/0_evals/3DDA_Trains/stack_cups/train1/15.24.29_Actor_18Peract_100Demo_multitask/diffusion_multitask-C120-B2-lr1e-4-DI1-2-H3-DT100
checkpoint_raw_folder=/media/funk/INTENSO/300_RL_BENCH/0_evals/URSA_Trains/open_drawer/08.58.48_PointAttn_18Peract_100Demo_multitask/diffusion_multitask-C120-B12-lr1e-4-DI1-2-H3-DT100
...
for ((i=0; i<$num_ckpts; i++)); do
    ...
    --output_file $checkpoint_raw_folder/${tasks[$i]}_eval_$j.json  \
