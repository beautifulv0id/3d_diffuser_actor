...
seed=0
checkpoint_raw_folder=/media/funk/INTENSO/300_RL_BENCH/0_evals/URSA_Trains/stack_blocks/18.57.14_PointAttn_18Peract_100Demo_multitask/diffusion_multitask-C120-B12-lr1e-4-DI1-2-H3-DT100
...
for ((i=0; i<$num_ckpts; i++)); do
    ...
    --output_file $checkpoint_raw_folder/${tasks[$i]}_eval1_$j.json  \
