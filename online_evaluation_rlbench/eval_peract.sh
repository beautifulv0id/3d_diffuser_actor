...
seed=0
log_dir="train_logs/2025.01.22/20.45.17_Actor_18Peract_100Demo_multitask/diffusion_multitask-C120-B4-lr1e-4-DI1-2-H3-DT100"
...
for ((i=0; i<$num_ckpts; i++)); do
    CUDA_LAUNCH_BLOCKING=0 xvfb-run -a python online_evaluation_rlbench/evaluate_policy_from_hparams.py \
    --tasks ${tasks[$i]} \
