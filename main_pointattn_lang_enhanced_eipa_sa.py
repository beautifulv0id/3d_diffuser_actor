...
from action_flow.se3_flow_matching_lang_enhanced_eipa_sa import SE3FlowMatchingLangEnhancedEIPASA
...
class Arguments(tap.Tap):
    ...
    exp_log_dir: str = "exp"
    run_log_dir: str = "run"
    name: str = 'pointattn_lang_enhanced_eipa_sa'
...
class TrainTester(BaseTrainTester):
    ...
    def get_model(self):
        ...
        _model = SE3FlowMatchingLangEnhancedEIPASA(
