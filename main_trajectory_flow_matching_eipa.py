...
from action_flow.diffuser_actor_fm_ipa import DiffuserActorSE3FlowMatchingEIPA
...
class Arguments(tap.Tap):
    ...
    exp_log_dir: str = "exp"
    run_log_dir: str = "run"
    name: str = 'trajectory_flow_matching_eipa'
...
class TrainTester(BaseTrainTester):
    ...
    def get_model(self):
        ...
        _model = DiffuserActorSE3FlowMatchingEIPA(
