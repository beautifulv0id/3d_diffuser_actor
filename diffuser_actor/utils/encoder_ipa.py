...
from geo3dattn.model.ipa_transformer.ipa_transformer import InvariantPointTransformer, EfficientInvariantPointAttention
...
class EncoderIPA(nn.Module):
    ...
    def __init__(self,
        ...
        self.gripper_context_head = InvariantPointTransformer(dim=embedding_dim,
                                    depth=3,
                                    heads=num_attn_heads,
                                    dim_head=embedding_dim//num_attn_heads,
                                    point_dim=1,
