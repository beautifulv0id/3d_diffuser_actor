...
from diffuser_actor.trajectory_optimization.diffuser_actor_flow_matching_6D import DiffuserActorFlowMatching
...
class Arguments(tap.Tap):
    ...
    exp_log_dir: str = "exp"
    run_log_dir: str = "run"
    name: str = '3d_diffuser_actor_flow_matching_6D'
...
class TrainTester(BaseTrainTester):
    ...
    def get_model(self):
        ...
        _model = DiffuserActorFlowMatching(
