...
data_dir=/workspace/data/peract/raw/test/
num_episodes=100
...
seed=0
log_dir="/workspace/train_logs/2025.01.24/18.54.15_PointAttn_18Peract_100Demo_multitask/diffusion_multitask-C120-B8-lr1e-4-DI1-2-H3-DT100"
