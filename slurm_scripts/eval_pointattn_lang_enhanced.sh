...
#SBATCH -J eval_pointattn_lang_enhanced_peract

# Default values
exp="2025.01.27/09.42.37_PointAttnLangEnhanced_18Peract_100Demo_multitask/pointattnlangenhnced_multitask-C120-B24-lr1e-4-DI1-2-H3-DT100"
tasks=stack_blocks
seed="0"
