...
CUDA_LAUNCH_BLOCKING=1 WANDB_PROJECT=3d_diffuser_actor_debug torchrun --nproc_per_node $ngpus --master_port $RANDOM \
    main_pointattn_nf25_4.py \
    --tasks insert_onto_square_peg \
    --checkpoint /home/funk/Code/3d_repr/3d_diffuser_actor/train_logs/2025.02.16/23.48.03_PointAttn_18Peract_100Demo_multitask/diffusion_multitask-C120-B3-lr1e-4-DI1-2-H3-DT100/last.pth \
    --dataset $dataset \
    --valset $valset \
