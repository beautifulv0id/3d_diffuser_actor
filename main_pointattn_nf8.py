...
from action_flow.se3_flow_matching_self_attn_felix_enc_x2 import SE3FlowMatchingSelfAttn as SE3FlowMatching
...
class Arguments(tap.Tap):
    ...
    exp_log_dir: str = "exp"
    run_log_dir: str = "run"
    name: str = 'train_point_attention_felix_enc_x2_self_attn'
