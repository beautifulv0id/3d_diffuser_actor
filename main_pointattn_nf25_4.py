...
from action_flow.se3_flow_matching_lang_enhanced_01_mean_std_points_10_1 import SE3FlowMatchingLangEnhanced as SE3FlowMatching
...
class Arguments(tap.Tap):
    ...
    exp_log_dir: str = "exp"
    run_log_dir: str = "run"
    name: str = 'train_point_attention_felix_enc_x1_100_lang_enhanced_no_do'
...
class TrainTester(BaseTrainTester):
    ...
    def evaluate_nsteps(self, model, criterion, loader, step_id, val_iters,
        ...
        if dist.get_rank() == 0:
            ...
            values[viz_key] = wandb.Image(viz.transpose(1,2,0))
            self.wandb_run.log(values, step=step_id)
