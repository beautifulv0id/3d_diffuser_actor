...
from geo3dattn.model.ursa_transformer.ursa_transformer import URSATransformer, URSATransformer10, URSATransformer11
...
class SE3GraspPointCloudEncoder10(ModuleAttrMixin):
    def __init__(self, dim_features=128, gripper_depth=3, nheads=4, n_steps_inf=50, nhist=3, num_vis_ins_attn_layers=2):
        super(SE3GraspPointCloudEncoder10, self).__init__()
        ...
        ## Gripper History Encoder ##
        self.gripper_decoder = URSATransformer10(dim_features, nhead=nheads, num_layers=gripper_depth)
...
class SE3GraspPointCloudEncoder11(ModuleAttrMixin):
    def __init__(self, dim_features=128, gripper_depth=3, nheads=4, n_steps_inf=50, nhist=3, num_vis_ins_attn_layers=2):
        super(SE3GraspPointCloudEncoder11, self).__init__()
        ...
        ## Gripper History Encoder ##
        self.gripper_decoder = URSATransformer11(dim_features, nhead=nheads, num_layers=gripper_depth)
