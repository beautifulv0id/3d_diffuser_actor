...
from geo3dattn.model.ursa_transformer.ursa_transformer import URSATransformerDiff3 as URSATransformer
...
class SE3FlowMatching(nn.Module):
    ...
    def __init__(self,
        ...
        decoder = URSATransformer(d_model=embedding_dim, nhead=12, num_layers=12, dropout=0.0)
