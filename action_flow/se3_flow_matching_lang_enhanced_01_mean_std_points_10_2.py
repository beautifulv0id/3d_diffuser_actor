...
from action_flow.utils.encoder import SE3GraspPointCloudEncoder11, FeaturePCDEncoder
from action_flow.utils.decoder import LangEnhancedURSADecoder10, LangEnhancedURSADecoder11
...
class SE3FlowMatchingLangEnhanced(nn.Module):
    ...
    def __init__(self,
        ...
        encoder = SE3GraspPointCloudEncoder11(
        ...
        decoder = LangEnhancedURSADecoder11(d_model=embedding_dim,
